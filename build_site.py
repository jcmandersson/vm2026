...
vm-tipset-2026.html (mellan markörerna). Tipsen/strukturen ligger redan i filen.
Körs av den schemalagda uppgiften efter varje match."""
import json, re, os
HERE=os.path.dirname(os.path.abspath(__file__))
html=open(os.path.join(HERE,"vm-tipset-2026.html"),encoding="utf-8").read()
...
open(os.path.join(HERE,"vm-tipset-2026.html"),"w",encoding="utf-8").write(html)
