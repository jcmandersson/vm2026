...
<div class="kogrid" id="bracketWrap"></div></div></section>
  <section class="view" id="tables"><div class="card"><div class="ttl"><span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/></svg></span>Grupptabeller · faktiska resultat</div><div class="grid2" id="tablesWrap"></div></div></section>
