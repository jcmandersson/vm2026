...
@media(hover:hover){.hdr .tog:hover{transform:translateY(-2px) rotate(-10deg);background:rgba(255,255,255,.26)}}
.hdr .tog{display:grid;place-items:center}.hdr .tog svg{width:20px;height:20px}
